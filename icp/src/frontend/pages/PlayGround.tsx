...
const PlayGround: React.FC = () => {
  ...
  return (
    <div className="relative flex h-screen text-gray-800 font-sans bg-white">
      {/* Chat Interface */}
      <div className="flex flex-col w-full h-full max-w-6xl mx-auto">
        ...
        <div className="bg-white border-b border-gray-200 px-6 flex items-center">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-lg font-semibold text-gray-900 py-2">Consensus Sentry Guardrail Safety Suite</h1>
            </div>
          </div>
        </div>
        ...
        <div className="flex-grow flex flex-col">
              ...
              <div key={item.timestamp.getTime()} className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <div className="flex-grow">
                    <p className="p-3 rounded-lg text-gray-800 max-w-md bg-gray-100">
          ...
          <form 
            ...
            className="absolute bottom-0 left-0 w-full bg-white p-4 border-t border-gray-200 flex items-center space-x-2 mb-4"
          >
            <textarea
              ref={inputRef}
              value={inputText}
              ...
              rows={1}
              className="flex-1 p-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500"
      ...
      {/* Error Overlay */}
      {error && (
        <div className="fixed inset-0 bg-blue-100 opacity-95 flex items-center justify-center">
          <div className="bg-red-200 p-4 rounded-lg text-center border border-red-300">
